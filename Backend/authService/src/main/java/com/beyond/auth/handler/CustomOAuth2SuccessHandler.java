package com.beyond.auth.handler;



import com.beyond.auth.dto.oAuth2.CustomOAuth2Member;
import com.beyond.auth.jwt.JWTUtil;
import com.beyond.auth.service.RefreshTokenService;
import com.beyond.auth.util.CookieUtil;
...
public class CustomOAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        response.sendRedirect("http://localhost:5173/oauth2-jwt-header?email=" + encodedEmail);
    }
